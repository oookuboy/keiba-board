...
FEATURE_COLUMNS = [
    ...
    *SPEED_FEATURES,
    # 調教（netkeiba 有料）。指数を入れたうえで2度測って、どちらも同じ向きに
    # 同じくらい動いた（+0.00295 と +0.00341）。切り口では「キャリア2走以下」
    # （2,592行）が +0.0083 / +0.0079 で2回とも閾値を超えた。過去走の統計が
    # 立たない馬ほど調教の比重が上がる、という事前の理屈とも合う。
    #
